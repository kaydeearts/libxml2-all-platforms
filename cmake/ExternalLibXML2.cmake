...
if(WIN32)
  set(LIBXML2_LIBNAME libxml2sd.lib)
else()
...
ExternalProject_Add(${LIBXML2_TARGET}
  ...
  INSTALL_COMMAND ""
  BUILD_BYPRODUCTS ${CMAKE_CURRENT_BINARY_DIR}/${LIBXML2_TARGET}/bin/Debug/${LIBXML2_LIBNAME}
)
...
set_target_properties(libxml2 PROPERTIES
  IMPORTED_LOCATION ${CMAKE_CURRENT_BINARY_DIR}/${BINARY_DIR}/Debug/${LIBXML2_LIBNAME}
